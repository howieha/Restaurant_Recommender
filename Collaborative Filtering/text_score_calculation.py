...
if __name__ == "__main__":
    # Train classifier.
    classifier = train_bayes_classifier('dict')
    ...
    db_review = pd.read_csv(r"test/test/db_review.tsv",
                    dtype=rvd_type,
                    sep='\t', na_values='None')
    ...
    output_path = os.path.join(os.path.dirname(__file__), "test/test/dataset_review_emo_bayes.tsv")
