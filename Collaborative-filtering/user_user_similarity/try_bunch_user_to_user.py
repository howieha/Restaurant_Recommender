...
dataset_user=pd.read_csv('dataset_user.tsv', sep="\t") 
with open("test1.tsv","w") as csvfile: 
	...
	for i in range(67715):
		print(t)
		t=t+1;
		a=similarity_calculation(user.iloc[i,1:],user.iloc[0:10000,1:])
		#print(DataFrame(a))
...
with open("test2.tsv","w") as csvfile: 
	writer = csv.writer(csvfile)
	writer.writerow(np.hstack(("index", users.reshape(1,-1)[0,:])))
	x=[]
	y=[]
	...
	for i in range(67715):
		print(t)
		t=t+1;
		a=similarity_calculation(user.iloc[i,1:],user.iloc[10000:20000,1:])
		#print(DataFrame(a))
		a=np.hstack((i,a[0,:]))		
		a=DataFrame(a)
		writer.writerow(a.T.iloc[0,:])
		
with open("test3.tsv","w") as csvfile: 
	writer = csv.writer(csvfile)
	writer.writerow(np.hstack(("index", users.reshape(1,-1)[0,:])))
	x=[]
	y=[]
	...
	for i in range(67715):
		print(t)
		t=t+1;
		a=similarity_calculation(user.iloc[i,1:],user.iloc[20000:30000,1:])
		#print(DataFrame(a))
		a=np.hstack((i,a[0,:]))		
		a=DataFrame(a)
		writer.writerow(a.T.iloc[0,:])

with open("test4.tsv","w") as csvfile: 
	writer = csv.writer(csvfile)
	writer.writerow(np.hstack(("index", users.reshape(1,-1)[0,:])))
	x=[]
	y=[]
...
with open("test5.tsv","w") as csvfile: 
	writer = csv.writer(csvfile)
	writer.writerow(np.hstack(("index", users.reshape(1,-1)[0,:])))
	x=[]
	y=[]
...
with open("test6.tsv","w") as csvfile: 
	writer = csv.writer(csvfile)
	writer.writerow(np.hstack(("index", users.reshape(1,-1)[0,:])))
	x=[]
	y=[]
...
with open("test7.tsv","w") as csvfile: 
	writer = csv.writer(csvfile)
	writer.writerow(np.hstack(("index", users.reshape(1,-1)[0,:])))
	x=[]
	y=[]
